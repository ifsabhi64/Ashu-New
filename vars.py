...
BOT_TOKEN = environ.get("BOT_TOKEN", "7858303470:AAGNUxps76MVt485y9s3ESjuHQFYT_xHHXg")
...
AUTH_USER = os.environ.get('AUTH_USERS', '8036182138,8066983572,1182777261').split(',')
